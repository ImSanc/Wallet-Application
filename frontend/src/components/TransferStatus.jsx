...
export function TransferStatus({ success }) {
  return (
    <div className={`${!success ? 'bg-red-100' : 'bg-green-100'}  w-screen h-screen flex justify-center items-center`}>
      <div className={`flex flex-col justify-between items-center ${!success ? 'bg-red-400' : 'bg-green-400'} rounded-lg w-[30%] h-[30%] font-medium p-4`}>
