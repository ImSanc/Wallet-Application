    ...
    return (
        <div className=" mx-10 ">
            ...
            <div className=" mt-auto">
                <button onClick={onClick} type="button" className=" mt-2 w-full text-white bg-green-500 hover:bg-green-400  font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2">{buttonName}</button>
            </div>
        </div>
    )
}